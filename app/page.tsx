            ...
            <IPhoneFrame>
              <div className="relative w-full h-full overflow-hidden">
                    ...
                    {[...Array(4)].map((_, i) => (
                      <div
                        ...
                        style={{
                          ...
                          height: '4px',
                          background:
                            'linear-gradient(90deg, transparent 0%, rgba(255,193,7,0.15) 30%, rgba(255,152,0,0.2) 70%, transparent 100%)',
                ...
                <div className="absolute bottom-20 left-1/2 -translate-x-1/2">
                  <motion.div className="bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
