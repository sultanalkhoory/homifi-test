          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="relative flex flex-col items-center">
              <div className="relative">
                {/* Glow behind iPhone */}
                <div className="absolute -inset-40 bg-gradient-to-tr from-blue-200/40 to-purple-200/40 blur-3xl rounded-full" />

                {/* Feature cards (entrance only, no idle float) */}
                {[
                  {
                    id: "voice",
                ...
                {/* iPhone in center (subtle Apple-style float) */}
                <motion.div
                ...
                >
                  <motion.div
                    animate={{ y: [0, -6, 0], rotate: [0, 0.15, 0, -0.15, 0] }}
