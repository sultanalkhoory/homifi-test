            ...
            <div className="flex items-center justify-between bg-white/80 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span 
                  ...
                  style={{ 
                    animation: isActive ? 'temperatureGlow 2s ease-in-out infinite' : 'none'
                  }}
                >
                  {temperature}°C
                </span>
                  ...
                  {[...Array(8)].map((_, i) => (
                    <div
                      ...
                      style={{
                        left: `${20 + (i * 8)}%`,
                        top: `${30 + (i % 3) * 10}%`,
                        animation: `airFlow ${2 + (i * 0.3)}s ease-in-out infinite`,
